...
public class TestRepairStateImpl
{
    ...
    {
        long expectedAtMostRepairedAt = expectedAtLeastRepairedAt + TimeUnit.DAYS.toMillis(1);
        ...
        assertThat(repairStateSnapshot.repairGroups()).isEqualTo(replicaRepairGroups);
        assertThat(repairStateSnapshot.canRepair()).isEqualTo(canRepair);
        assertThat(repairStateSnapshot.vnodeRepairStates()).isEqualTo(vnodeRepairStatesBase.combineWithRepairedAt(repairStateSnapshot.lastCompletedAt()));
    }
