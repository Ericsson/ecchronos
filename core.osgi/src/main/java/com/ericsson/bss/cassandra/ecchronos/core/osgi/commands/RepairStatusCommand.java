...
public class RepairStatusCommand implements Action
{
    ...
    private static final String SORT_NEXT_REPAIRED = "NEXT_REPAIR";
    ...
    @Option(name = "-s", aliases = {"--sort"}, description = "Sort output based on " + SORT_TABLE_NAME + "/" + SORT_REPAIRED_RATIO + "/" + SORT_REPAIRED_AT + "/" + SORT_NEXT_REPAIRED, required = false, multiValued = false)
    @Completion(value = StringsCompleter.class, values = {SORT_TABLE_NAME, SORT_REPAIRED_RATIO, SORT_REPAIRED_AT, SORT_NEXT_REPAIRED})
