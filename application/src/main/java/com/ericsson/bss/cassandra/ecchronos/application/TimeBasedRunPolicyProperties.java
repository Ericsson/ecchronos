...
public class TimeBasedRunPolicyProperties
{
    ...
    private TimeBasedRunPolicyProperties(String keyspaceName)
    {
    ...
    public static TimeBasedRunPolicyProperties from(Properties properties)
    {
        String keyspaceName = properties.getProperty(CONFIG_KEYSPACE, DEFAULT_KEYSPACE);

        return new TimeBasedRunPolicyProperties(keyspaceName);
    }
}
