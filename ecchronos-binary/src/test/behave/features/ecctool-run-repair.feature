Feature: ecctool run-repair
  ...
  Scenario: Run cluster-wide repair for keyspace test2 and table table2
    ...
    Then the output should contain a valid repair header
    And the output should contain 3 repair rows for test2.table2 with type VNODE
    And the output should not contain more rows
    And the output should contain a valid repair summary
  ...
  Scenario: Run cluster-wide repair for keyspace test2
    ...
    Then the output should contain a valid repair header
    And the output should contain 3 repair rows for test2.table2 with type VNODE
    And the output should contain 3 repair rows for test2.table1 with type VNODE
    And the output should not contain more rows
    And the output should contain a valid repair summary
  ...
  Scenario: Run cluster-wide repair for all keyspaces and tables
    ...
    When we run repair
    Then the output should contain a valid repair header
    And the output should contain 3 repair rows for keyspaceWithCamelCase.tableWithCamelCase with type VNODE
    And the output should contain 3 repair rows for test.table2 with type VNODE
    And the output should contain 3 repair rows for test.table1 with type VNODE
    And the output should contain 3 repair rows for test2.table2 with type VNODE
    And the output should contain 3 repair rows for test2.table1 with type VNODE
    And the output should not contain more rows
    And the output should contain a valid repair summary
