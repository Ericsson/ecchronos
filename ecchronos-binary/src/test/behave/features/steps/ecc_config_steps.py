...
CONFIG_LINE_PATTERN = r'\| {keyspace} \| {table} \| {interval} \| PARALLEL | {unwind} \| {warn} \| {error} \|'

CONFIG_HEADER = r'| Keyspace | Table | Interval | Parallelism | Unwind ratio | Warning time | Error time |'
