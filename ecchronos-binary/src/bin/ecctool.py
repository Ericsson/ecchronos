...
def add_repairs_subcommand(sub_parsers):
    ...
    parser_repairs.add_argument("-l", "--limit", type=int,
                                help="Limits the number of rows printed in the output. Specified as a number, "
                                     "-1 to disable limit.",
                                default=-1)
    parser_repairs.add_argument("-j", "--job", type=str,
                                help="Show schedules matching the specified jobID.")
...
def add_schedules_subcommand(sub_parsers):
    ...
    parser_schedules.add_argument("-i", "--id", type=str,
                                  help="Show schedules matching the specified NodeID.")
    parser_schedules.add_argument("-j", "--job", type=str,
                                  help="Show schedules matching the specified jobID.")
...
def add_run_repair_subcommand(sub_parsers):
    ...
    parser_run_repair.add_argument("-u", "--url", type=str,
                                   help="The ecChronos host to connect to, specified in the format "
                                        "http://<host>:<port>.",
                                   default=None)
    parser_run_repair.add_argument("-i", "--id", type=str,
                                   help="The Cassandra node to run the repair.",
                                   default=None)
...
def repair_info(arguments):
    ...
    result = request.get_repair_info(node_id=arguments.id, keyspace=arguments.keyspace, table=arguments.table,
