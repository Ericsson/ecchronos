...
public class TestSubRangeRepairStatesCombine
{
    @Mock
    DriverNode mockNode;
    ...
    public void testCombineWithOlderTimestampReturnsSelf()
    {
        ...
        SubRangeRepairStates states = SubRangeRepairStates.newBuilder(Arrays.asList(vnode1, vnode2)).build();

        SubRangeRepairStates result = states.combineWithRepairedAt(4000L);
    ...
    public void testCombineWithEqualTimestampReturnsSelf()
    {
        ...
        SubRangeRepairStates states = SubRangeRepairStates.newBuilder(Collections.singletonList(vnode1)).build();

        SubRangeRepairStates result = states.combineWithRepairedAt(5000L);
    ...
    public void testCombineWithNewerTimestampUpdatesAll()
    {
        ...
        SubRangeRepairStates result = states.combineWithRepairedAt(9000L);
    ...
    public void testCombineWithMixedTimestampsUpdatesOnlyOlder()
    {
        ...
        SubRangeRepairStates states = SubRangeRepairStates.newBuilder(
                Arrays.asList(vnode1, vnode2, vnode3)).build();

        SubRangeRepairStates result = states.combineWithRepairedAt(3000L);
    ...
    public void testCombineWithUnrepairedTimestampReturnsSelf()
    {
        ...
        SubRangeRepairStates result = states.combineWithRepairedAt(VnodeRepairState.UNREPAIRED);
